...
INPUT_FILE = Path("/home/deploy/data/scrapers/mcfabrika/mcfabrika_events.csv")
OUTPUT_FILE = Path("/home/deploy/data/scrapers/mcfabrika/mcfabrika_events_edited.csv")
