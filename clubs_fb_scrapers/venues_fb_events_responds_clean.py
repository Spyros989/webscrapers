...
input_file = "/home/deploy/data/scrapers/cz_clubs_fb_events/venues_fb_events_responds.csv"
output_file = "/home/deploy/data/scrapers/cz_clubs_fb_events/venues_fb_events_responds_clean.csv"
...
df = df.rename(columns={"url": "event_url"})
# =========================================================
# COLUMN ORDER
# =========================================================
column_order = [
