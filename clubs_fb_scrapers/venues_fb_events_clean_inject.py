...
df = pd.read_csv("/home/deploy/data/scrapers/cz_clubs_fb_events/venues_fb_events_clean.csv")
...
df.to_sql("venues_fb_events_raw", engine, if_exists="append", index=False)
